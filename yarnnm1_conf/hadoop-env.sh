...
export HDFS_SECONDARYNAMENODE_OPTS="-Dcom.sun.management.jmxremote $HDFS_SECONDARYNAMENODE_OPTS \
   	-Dcom.sun.management.jmxremote.port=10001 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"
export HDFS_DATANODE_OPTS="-Dcom.sun.management.jmxremote $HDFS_DATANODE_OPTS \
   	-Dcom.sun.management.jmxremote.port=10002 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"
export HADOOP_BALANCER_OPTS="-Dcom.sun.management.jmxremote $HADOOP_BALANCER_OPTS \
   	-Dcom.sun.management.jmxremote.port=10003 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"
...
# export HADOOP_OPTIONAL_TOOLS="hadoop-aliyun,hadoop-kafka,hadoop-azure-datalake,hadoop-azure,hadoop-openstack,hadoop-aws"
