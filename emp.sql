...
CREATE INDEX emp_idx0 ON emp(age DESC) include (name,boss) async;
CREATE INDEX emp_idx1 ON emp(name DESC) include (gender,boss) async;
CREATE INDEX emp_idx2 ON emp(name DESC, email) include (age,boss) async;
