...
SPARK_HISTORY_OPTS="-Dspark.history.ui.port=18080 -Dspark.eventLog.enabled=true -Dspark.eventLog.dir=hdfs://grakrabackend/spark_history -Dspark.history.fs.logDirectory=hdfs://grakrabackend/spark_history"
